...
gfortran -g -fcheck=all -Wall -fopenmp -o mlxanes mlxanes.f95 functions.o cmcalc.o reducekgrid.o read_xyz.o predict_xanes.o read_xanes.o read_setup.o count_xanes.o x2_gradient_descent.o 
